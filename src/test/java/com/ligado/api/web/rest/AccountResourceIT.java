...
import static com.ligado.api.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.ligado.api.IntegrationTest;
import com.ligado.api.config.Constants;
import com.ligado.api.domain.User;
import com.ligado.api.repository.AuthorityRepository;
import com.ligado.api.repository.UserRepository;
import com.ligado.api.security.AuthoritiesConstants;
import com.ligado.api.service.UserService;
import com.ligado.api.service.dto.AdminUserDTO;
import com.ligado.api.service.dto.PasswordChangeDTO;
import com.ligado.api.service.dto.UserDTO;
import com.ligado.api.web.rest.vm.KeyAndPasswordVM;
import com.ligado.api.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testChangePassword() throws Exception {
        User user = new User();
        String currentPassword = RandomStringUtils.randomAlphanumeric(60);
        String newPassword = RandomStringUtils.randomAlphanumeric(60);
        user.setPassword(passwordEncoder.encode(currentPassword));
